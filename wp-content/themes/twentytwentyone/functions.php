...
function my_custom_init()
{
	...
	register_taxonomy('product-category', ['repair-parts'], [
		'label'                 => '',
		'labels'                => [
			'name'              => 'Category',
	...
	register_post_type('repair-parts', array(
		'labels'             => array(
			'name'               => 'Repair parts',
			'singular_name'      => 'Repair parts',
			'add_new'            => 'Add New Repair parts',
			'add_new_item'       => 'Add New Repair parts',
			'edit_item'          => 'Edit Repair parts',
			'new_item'           => 'New Repair parts',
			'view_item'          => 'View Item',
			'search_items'       => 'Search Repair parts',
			'not_found'          => 'Repair parts not found',
			'not_found_in_trash' => 'Not Found In Trash',
			'parent_item_colon'  => '',
			'menu_name'          => 'Repair parts'
...
add_action('rest_api_init', function () {
	register_rest_route('myplugin/v1', '/category/', array(
		'methods' => 'GET',
...
function my_awesome_func()
{
	...
	foreach($terms as $term){
		...
		$test_result = (object) ["name" => $term->name, "id" => $term->term_id, "iamge" => $upload_image ];
		array_push($return_result , $test_result);
	}

	return wp_send_json_success($return_result);
}

add_action('product-category_add_form_fields', 'add_term_image', 10, 2);
...
add_action('created_product-category', 'save_term_image', 10, 2);
...
add_action('product-category_edit_form_fields', 'edit_image_upload', 10, 2);
...
add_action('edited_product-category', 'update_image_upload', 10, 2);
